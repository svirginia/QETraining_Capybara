...
After do |scenario|
  if(scenario.failed?)
      #save_and_open_page   #optionA for debugging
      #print page.html   #optionB for debugging
      if(scenario.failed?)
        screenshot_name = scenario.__id__.to_s + ".png"  #__id__  ide aleatorios
        page.driver.browser.save_screenshot("screenshots/#{screenshot_name}") #folder screenshots crear al nivel de feature
